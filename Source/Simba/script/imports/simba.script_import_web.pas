...
begin
  ...
  begin
    ...
    addGlobalFunc('function PostHTTPForm(Client: Int32; const URL, FieldName, FileName: string): String; overload;', @Lape_FormPost);
    addGlobalFunc('function PostHTTPForm(Client: Int32; const URL, FieldName, FileName: string; Stream: TStream): String; overload;', @Lape_FormPostEx);
