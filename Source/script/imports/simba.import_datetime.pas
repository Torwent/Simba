...
begin
  ...
  begin
    ...
    addDelayedCode([
      ...
      '  begin',
      '    Self.PausedTime += PerformanceTimer() - Self.StoppedTime;',
      '    Self.StoppedTime := 0;',
      '  end else',
      ...
      '    Result := (PerformanceTimer() - Self.StartTime) - (PerformanceTimer() - Self.StoppedTime)',
      '  else',
      '    Result := (PerformanceTimer() - Self.StartTime) - Self.PausedTime;',
      'end;',
      '',
      ...
      'begin',
      '  Self.StopTime := Self.StartTime := Self.PausedTime := 0;',
      'end;'],
      DumpSection);
